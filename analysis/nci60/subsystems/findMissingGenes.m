...
%misssingGenes is a cell array containg one row and columns that each contain cell arrays of all
%the missing genes associated with a particular subsystem. It can be generated by using 
%the function analyzeSubsystemEnrichment (missingGenesMRNA or missingGenesProtein)
%OUTPUT
...
%remove duplicate rxns. Note not all "missing rxns" may actually be missing because of and/or gene rules 
rxnList(1) = temp2(1);
rxnNames{1} = temp3{1};
count = 2;
