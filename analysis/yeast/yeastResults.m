...
fprintf(fresults, ['%s' repmat('\t%g', 1, 8) '\n'], 'R2', 1,                      ...
    rsquared(p_gene_exp, experimental), rsquared(p_standard_fba, experimental),   ...
    rsquared(p_standard_fba_best,experimental), rsquared(p_gimme, experimental),  ...
    rsquared(p_shlomi, experimental), rsquared(p_fix, experimental),              ...
    rsquared(p_falcon, experimental));
...
fprintf(fresults,'%s\t%g\t%g\t%g\t%g\t%g\t%g\t%g\t%g\n','R2',1,rsquared(p_gene_exp,experimental),rsquared(p_standard_fba,experimental),rsquared(p_standard_fba_best,experimental),rsquared(p_gimme,experimental),rsquared(p_shlomi,experimental),rsquared(p_fix,experimental),rsquared(p_falcon,experimental));
